            ...
            <div class="col-lg-8 col-md-12">
                <div class="courses-details">
                        ...
                        <ul>
                            <li>
                                <div class="teacher-img">
                                    <img src="{{asset('assets/img/teacher-one.jpg')}}" alt="teacher">
                                </div>
                    ...
                    <div class="courses-details-img">
                        <img src="{{asset('assets/img/courses-details.jpg')}}" alt="courses-details">
                    </div>
                        ...
                        <div class="content" id="tab_4_content">
                            <div class="courses-review">
                                <div class="single-review">
                                    <div class="img">
                                        <img src="{{asset('assets/img/teacher-one.jpg')}}" alt="client">
                                    </div>
                ...
                <div class="side-bar mb-0">
                    ...
                    <div class="single-widget latest-courses">
                        ...
                        <div class="single-latest-courses">
                            <div class="img">
                                <a href="#"><img src="{{asset('assets/img/course-one.jpg')}}" alt="course"></a>
                            </div>
                        ...
                        <div class="single-latest-courses">
                            <div class="img">
                                <a href="#"><img src="{{asset('assets/img/course-two.jpg')}}" alt="course"></a>
                            </div>
                        ...
                        <div class="single-latest-courses mb-0">
                            <div class="img">
                                <a href="#"><img src="{{asset('assets/img/course-three.jpg')}}" alt="course"></a>
                            </div>
