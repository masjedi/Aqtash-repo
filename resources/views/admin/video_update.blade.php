            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Update Video</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active" >Video Update Form</li>
                        </ol>
                    </div>
                </div>
                <div class="row" style="margin-left: 120px; margin-right: 120px;">
                    ...
                    <div class="col-md-12 col-sm-6" >
                        <div class="card card-box">
                            <div class="card-head">
                                <header style="color:#133984  ;">Video Update Form</header>
                            ...
                            <div class="card-body " id="bar-parent">
                                <form action="{{route('video.update', $video->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$video->video_name}}" name="video_name" type="text" class="form-control" id="simpleFormEmail"
                                               placeholder="Teacher Name ">
                                    </div>
                                    <div class="form-group">
                                        <label for="simpleFormEmail"> URL</label>
                                        <input value="{{$video->video_url}}"  name="video_url" type="text" class="form-control" id="simpleFormEmail"
