            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Add Meeting</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li><a class="parent-item" href="#">Meeting</a>&nbsp;<i class="fa fa-angle-right"></i>
                            </li>
                ...
                <div class="row" style="margin-left: 120px; margin-right: 120px;">
                    ...
                    <div class="col-md-12 col-sm-6" >
                        <div class="card card-box">
                            <div class="card-head">
                                <header style="color:#133984  ;">Meeting Form</header>
                            ...
                            <div class="card-body " id="bar-parent">
                                <form action="{{route('admin.meet.store')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="images[]" multiple id="simpleFormEmail"
                                               placeholder=" Meeting Image">
                                    </div>
                                    <div class="form-group">
